...
public abstract class PullToRefreshAdapterViewBase<T extends PLA_AbsListView> extends PullToRefreshBase<T> implements
		OnScrollListener {

	private static final boolean DEBUG = false;
	private static final String LOG_TAG = "PullToRefreshAdapterViewBase";
